...
(setf (gethash "delete"           realgud:mobdebug-command-hash) "delb %s %d")
(setf (gethash "clear"            realgud:mobdebug-command-hash) "delb %s %d")
(setf (gethash "break"            realgud:mobdebug-command-hash) "setb %s %d")
